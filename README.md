...
arroz integral con quinua ===> sin fibra


abuso de azucar...... 

//globalServices.AddSafe<IServiceAgent<IResponseViewService>>(new UnityServiceAgent<IResponseViewService>());
            globalServices.AddSafe<IServiceAgent<IResponseViewService>>(
                new ServiceAgent<IResponseViewService>(EndpointService.ResponseViewService));

            //globalServices.AddSafe<IServiceAgent<IViewQueryGeneratorService>>(new UnityServiceAgent<IViewQueryGeneratorService>());
            globalServices.AddSafe<IServiceAgent<IViewQueryGeneratorService>>(
                new ServiceAgent<IViewQueryGeneratorService>(EndpointService.ViewQueryGeneratorService));




publoc void processEvent(object event)
{
   --> update record in firebase
   --> update record in sql
   --> insert history data (nosql)
   --> 
}
